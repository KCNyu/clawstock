...
## 当前持仓梳理（基于 `portfolio.json` 2026-04-22 最近记录）
...
### 持仓特征
- 风格激进，波动容忍度较高
- 港股风险集中在 `07226`，`03032/03033` 属于相对更稳的科技敞口
- 美股当前偏成长和高弹性，新增杠杆短线仓 `PLTU`、`SOXL`、`RKLX`
- 关键联动仍然是 `MU/WDC -> 海力士/三星 -> 07709/07747`，但后两者目前应视作观察标的，不是当前持仓
